...
String aux = "";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Datos[0]=this.jComboBox1.getSelectedItem();
        Datos[1]=this.jComboBox2.getSelectedItem();
        Datos[2]=this.jTextField1.getText();
        Datos[3]=this.jTextField2.getText();
        Datos[4]=this.jLabel6.getText();
        Datos[5]=String.valueOf(cont);
        Datos[6]="1001";
        Datos[7]=this.jTextField6.getText();
        Datos[8]=this.jTextField3.getText();
        Datos[9]=SubTotal;
        Datos[10]="No tiene";
        Datos[11]=this.jTextField5.getText();
        Datos[12]=Total;
